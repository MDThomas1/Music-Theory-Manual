...
import FullNotation from '../images/Full-Notation.png'
import TimeSignature from '../images/Time-Signature.png'
...
const Notation = () => {
    return (
        <div id='notation' className='page'>
            ...
            <img className='static-img' src={FullNotation} alt='Failed to load' />
            <div id='clefs'>
                <h3>Clefs</h3>
            ...
            <div id='time-signatures'>
                ...
                <img className='static-img' src={TimeSignature} alt='Failed to load' />
            </div>
        </div>
    )
