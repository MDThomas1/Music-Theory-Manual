...
const Scales = () => {
    return (
        <div id='scales'>
            ...
            <div id='major-modes'>
                <h4>Major Modes</h4>
                <p>The different notes that make up the structure of a scale are known as scale degrees and, simply put, modes are created by taking the same sequence of notes that make up one scale and starting at a different scale degree, creating a new sound. Every scale can used be used to create modes but the modes of the major scale are the most commonly used in writing music.</p>
                <MajorModeList />
            </div>
